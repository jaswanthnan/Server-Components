        ...
        <div className="px-10 pb-10">
          <div className="relative -mt-12 flex items-end justify-between">
            <div className="flex items-end gap-6">
              ...
              <div className="pb-4">
                <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">{candidate.name}</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mt-12">
            <div className="lg:col-span-2 space-y-10">
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Professional Summary</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">
                  Highly motivated and results-driven {candidate.role} with {candidate.experience} years of experience. 
                  Demonstrated ability to deliver high-quality solutions and work effectively in cross-functional teams.
                </p>
              </section>

              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Key Skills</h3>
                <div className="flex flex-wrap gap-2">
                  {candidate.skills?.map((skill: any) => (
                    <span key={skill} className="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-xl text-sm font-semibold">
                      {skill}
                    </span>
                  ))}
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 dark:text-white text-lg">{candidate.role}</h4>
                      <p className="text-slate-500 font-medium">Previous Company • 2021 - Present</p>
                      <p className="mt-3 text-slate-600 dark:text-slate-400">
                        Led a team of developers to build and scale core product features. 
                        Improved system performance by 40% through architecture optimization.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-8 bg-slate-50 dark:bg-slate-800/50 rounded-[2rem] border border-slate-100 dark:border-slate-800 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 text-slate-600 dark:text-slate-400">
                    ...
                    <span className="font-medium">Applied on {formatDate(candidate.createdAt)}</span>
                  </div>
                </div>

                <div className="pt-6 border-t border-slate-200 dark:border-slate-800">
                  <h4 className="font-bold text-slate-900 dark:text-white mb-4">Attachments</h4>
